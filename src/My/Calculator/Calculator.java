...
public class Calculator extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jButton18, javax.swing.GroupLayout.DEFAULT_SIZE, 53, Short.MAX_VALUE)
    ...
    enable();        // call the enable function
    ...
    int length = jTextField1.getText().length(); // length() is a method that returns the length of a string
    int number = jTextField1.getText().length()-1; // subtract 1 from the string
    String store;
    if(length > 0)
    {
        StringBuilder back = new StringBuilder(jTextField1.getText());// creates empty string builder whifch is used to store strings
        back.deleteCharAt(number); // back is an object of StringBuilder, deletecharAt() is used to delete a single character from specific position
